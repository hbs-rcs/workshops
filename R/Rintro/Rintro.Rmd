...
Exercise 2.1 solution<span class="tag" data-tag-name="prototype"></span>
----------------------------------------------------------------------
...
Exercise 2.2 solution<span class="tag" data-tag-name="prototype"></span>
----------------------------------------------------------------------
...
```{r}
baby_names <- mutate(baby_names, logCount = Count/1000)
...
```{r}
baby_names_logCount <- select(baby_names, Name, Sex, Year, logCount)
head(baby_names_logCount)
```
...
```{r}
girls.and.boys <- inner_join(filter(baby_names, Sex == "Boys"), 
...
```{r}
top10 <- 
  most.popular %>% #it is already grouped by Year and Sex
